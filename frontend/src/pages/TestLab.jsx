...
// internally by the panel and re-exported for any future call site
// that needs the composer in isolation. The right-rail launch panel
// (`tl-panel`) still lives inline in this file — extraction
// follow-up.
