...
### Security
- Added per-project controls (`strictPiiFirewall`, `piiAllowlist`) to keep prompt-time PII redaction enabled by default while allowing explicit demo/training allowlist exceptions.
