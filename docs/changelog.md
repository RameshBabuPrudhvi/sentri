...
- **AI provider B2 follow-up** — Added `aiRequestLogRepo` repository, moved settings list/get replay reads to repository layer, and added daily request-log retention sweep (`AI_REQUEST_LOG_RETENTION_DAYS`, default 30 days) in `scheduler.js`.
