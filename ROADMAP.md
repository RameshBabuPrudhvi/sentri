...
>
> **Current sprint:** INF-009 (Helm chart + K8s readiness/liveness + DR playbook) — promoted after AUTO-009 (browser code coverage mapping MVP) shipped in PR #19. Queue: AUTO-022b (eval harness recording — deferred pending LLM API key + 4–8h maintainer session) slot 1, AUTO-014 (test dependency + execution ordering) slot 2, DIF-008 (Jira / Linear issue sync) slot 3. AUTO-009 follow-ups (AUTO-009b/c/d/e/f/g/h/i/j) tracked separately as differentiator-tier industry-standard coverage work — see ROADMAP § AUTO-009 follow-ups.
>
...
| Phase 4 — Autonomous Intelligence | Risk-based testing, change detection, quality gates | 🔄 In progress — AUTO-001/002/002b/003/003b/004/005/006/007/008/009/010/012/013/015/015b/016/016b/017/017.3/019 ✅ (AUTO-009 shipped in PR #19, AUTO-008 in PR #9, AUTO-010 in PR #6, AUTO-004 in PR #18, AUTO-001 in PR #15); remaining: AUTO-011, AUTO-014, AUTO-018, AUTO-021 (AUTO-020 superseded by AUTO-015) · AUTO-009 follow-ups tracked separately: 009b (source-map), 009c (S/B/F granularity), 009d (PR-scoped diff), 009e (coverage gates), 009f (shard parity — landed in same PR), 009g (memory ceiling — landed in same PR), 009h (server-side coverage), 009i (regression alerting), 009j (retention) · Capabilities row: CAP-001 (data-driven) ✅ PR #1, CAP-002 (sharding) ✅ PR #3; CAP-002b (SaaS-readiness follow-ups) tracked separately in Summary | 14–18 weeks |
