...
>
> **Current sprint:** `SEC-004` (MFA / TOTP / passkey support) — promoted after `AUTO-008` shipped in PR #9. SEC-006 (PII firewall) holds queue slot 1, SEC-007 (compliance audit log surface — promoted from 🟢 Strategic to 🟡 High; pairs with SEC-004 as a SOC2/ISO27001 prerequisite) slot 2, INF-007 (OTel) slot 3, INF-008 (Postgres-default + dual-DB CI matrix) slot 4.
>
...
>
> **Recent ships** (newest first; full details in the Completed Work Summary table — never inline implementation prose here, that's what the table is for): AUTO-008 PR #9 · DIF-015c Gaps 2/3/5/6 PR #8 · AUTO-010 PR #6 · DIF-012 PR #2 · CAP-001 PR #1 · CAP-002 PR #3 · AUTO-004 PR #18 · INT-002b PR #17 · AUTO-001 + INT-002 PR #15 · AI-001 PR #14 · CAP-003 + AUTO-002 + AUTO-002b + AUTO-015 + AUTO-015b PR #12 · DIF-015b Gap 3 + DIF-015c Gap 1 PR #11 · AUTO-003 + AUTO-003b + AUTO-019 PR #10 · AUTO-017.3 + PROC-001 + DIF-005 PR #9 (legacy) · CAP-004 + MET-001 + AUTO-017 + UI-REFACTOR-001 PR #8 (legacy). PROC-002 + PROC-003 reverted in PR #10.
